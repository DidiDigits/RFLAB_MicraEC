...
from debug.debug_utils import compare_thru_S21
...
def find_transmission_tracking(freq, error_params_p1, error_params_p2):
    ...
    # [DEBUG]: Comparar con THRU de referencia medido con PNA-X
    ...
    return np.asarray(result_tracking['alpha'], dtype=complex)
